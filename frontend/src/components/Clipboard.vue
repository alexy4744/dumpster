<template>
  <div class="clipboard">
    <input ref="link" class="clipboard__link" type="text" :value="link">
    <button class="clipboard__btn--copy" @click="copy">
      <svg
        width="24px"
        height="24px"
      ...
      >
        ...
        ></path>
        <path d="m75.976562 189.667969h227.597657v18.964843h-227.597657zm0 0"></path>
        <path d="m75.976562 132.765625h75.867188v18.96875h-75.867188zm0 0"></path>
        <path d="m75.976562 246.566406h151.734376v18.96875h-151.734376zm0 0"></path>
        <path d="m246.675781 246.566406h56.898438v18.96875h-56.898438zm0 0"></path>
        <path d="m75.976562 303.464844h227.597657v18.96875h-227.597657zm0 0"></path>
        <path d="m75.976562 417.265625h227.597657v18.96875h-227.597657zm0 0"></path>
        <path d="m161.324219 360.367188h142.25v18.964843h-142.25zm0 0"></path>
        <path d="m75.976562 360.367188h66.382813v18.964843h-66.382813zm0 0"></path>
        <path d="m75.976562 474.167969h37.933594v18.964843h-37.933594zm0 0"></path>
        <path d="m132.875 474.167969h170.699219v18.964843h-170.699219zm0 0"></path>
      </svg>
    </button>
  </div>
</template>
